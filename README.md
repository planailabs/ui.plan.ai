...
The root app emits `/sitemap.xml` for public app routes and `/v1-status.json` as a machine-readable snapshot of the current static shell. `public/robots.txt` advertises both the root sitemap and the Starlight docs sitemap.
