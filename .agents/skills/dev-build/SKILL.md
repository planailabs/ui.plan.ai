...
dist/
├── index.html, favicon.*
└── docs/{index.html (redirect), start-here/, foundations/, process/, v1-plan/, v2-plan/, v3-plan/, specifications/, api-reference/, reference/, roadmap-and-open-questions/, specs/, _astro/, pagefind/, sitemap-*.xml}
```
