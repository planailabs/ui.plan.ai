...
export default defineConfig({
	...
	integrations: [
		starlight({
			title: 'ui.plan.ai',
			description: 'Supabase-backed platform and Agent API for plan.ai agent-generated UI streams.',
			social: [{ icon: 'github', label: 'GitHub', href: 'https://github.com/planailabs/ui.plan.ai' }],
			components: {
