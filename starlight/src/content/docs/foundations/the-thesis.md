---
title: The thesis
description: What ui.plan.ai is testing and why the platform starts internally.
sidebar:
  order: 1
stability: stable
...
The first audience is internal. That is deliberate. V1 is for our team and our agents, because a public product would force quota, monetization, legal, and support work before the core pipeline is proven.
...
V1 creates the internal platform. V2 adds server generation. V3 opens the public hosted API after the internal system is worth selling.
