...
description: The contracts that define V1 data, API, routing, media, approval, and realtime behavior.
sidebar:
  order: 1
stability: stable
...
This section is the implementation contract layer. It defines V1 behavior at a level that engineers and agents can build from.
